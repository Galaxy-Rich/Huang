...
FarmTab:Toggle({
    ...
    Callback = function(state)
        if state then
            -- Langsung mencari dan menghapus objek secara permanen
...
local positions = {
    SaveZone = CFrame.new(1951.49939, 22.0321541, 6184.75439, 0.930111349, 0.00488819974, -0.367245138, -1.02040842e-09, 0.999911427, 0.0133092729, 0.367277682, -0.0123791052, 0.930028975),
    Zone1 = CFrame.new(3.76485586, 182.867279, 251.610687, 0.999981582, -0.00028990017, 0.00605749246, 6.98018726e-11, 0.998856783, 0.0478033908, -0.00606442569, -0.0478025116, 0.998838425),
    Zone2 = CFrame.new(-2.79073954, 70.223381, -204.05986, -0.999994338, -0.000113214184, -0.00336426566, 1.85168946e-11, 0.999434233, -0.0336329415, 0.00336616999, -0.0336327516, -0.99942857)
}
...
task.spawn(function()
    while true do
        ...
        task.wait(0.005) -- 0.1 sudah cukup cepat dan tidak bikin lag
    end
end)
...
FarmTab:Toggle({
    ...
    Callback = function(enabled)
        currentTarget = enabled and positions.SaveZone or nil
    end
})
